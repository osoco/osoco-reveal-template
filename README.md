# OSOCO Presentation Template based on Reveal.js

This is a simple project to be used as the template to build HTML-based presentations at OSOCO.

To write a new presentation using this template you should follow these simple steps:
